...
const filterData = (req) => {
    ...
    if (req.query.topic_category_id) {
        $where["topic_category_id"] = parseInt(req.query.topic_category_id);
    }
        ...
        try {
            const item = await prisma[$table].create({
                data: {
                    ...
                    topic_category_id: Number(req.body.topic_category_id),
                    // created_by: null,
                    // updated_by: null,
                },
            });
        ...
        try {
            const item = await prisma[$table].update({
                ...
                data: {
                    ...
                    is_active: Number(req.body.is_active),
                    topic_category_id: req.body.topic_category_id != null ? Number(req.body.topic_category_id) : undefined,
                    // updated_by: null,
                },
            });
